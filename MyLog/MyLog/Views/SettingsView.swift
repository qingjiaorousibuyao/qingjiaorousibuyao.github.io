...
struct SettingsView: View {
    ...
    var body: some View {
        Form {
            ...
            Section("个性化") {
                ...
                if theme.homeBackgroundData != nil {
                    Button("移除主页背景", role: .destructive) { theme.homeBackgroundData = nil }
                }
                ...
                VStack(alignment: .leading) {
                    ...
                    Slider(value: $theme.cardOpacity, in: 0.5...1.0)
                }
            }
        ...
        .tint(theme.accent)
        .onChange(of: backgroundItem) { _, item in Task { theme.homeBackgroundData = try? await item?.loadTransferable(type: Data.self) } }
